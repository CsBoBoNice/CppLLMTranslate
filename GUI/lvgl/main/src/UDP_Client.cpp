 ...
 * @LastEditTime: 2024-08-22 14:15:10
 * @FilePath: /CppLLMTranslate/GUI/lvgl/main/src/UDP_Client.cpp
 */
...
void UDP_Client::Send_thread()
{
    while (true) {
        ...
        int ret = sendto(socketfd, message.c_str(), message.length(), 0, (struct sockaddr *)&server_addr,
                         sizeof(server_addr));
